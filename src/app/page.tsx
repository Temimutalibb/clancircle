        ...
        <section aria-labelledby="how-it-works" className="mt-10">
          ...
          <div className="flex gap-2 flex-wrap items-center justify-between">
            {[
              ...
              {
                step: "3",
                text: "Earn $CLAN tokens for every interaction",
              },
              {
                step: "4",
                text: "Use $CLAN to unlock premium features or cash out!",
              },
            ].map(({ step, text }) => (
              <div
                key={step}
          ...
          <div className="flex flex-col gap-2">
            ...
            {[
              ...
              },
              {
                ...
                description: "Earn and trade $CLAN",
              },
              {
                icon: "/group.png",
                title: "For Everyone",
          ...
          <div className="flex flex-col mb-10 mt-10 gap-5  items-center">
            <div className="list-inside list-decimal text-sm text-center sm:text-left font-[family-name:var(--font-geist-mono)]">
              <div className="mb-1">
                ...
                investor-friendly ICO, $CLAN presents a compelling opportunity
