    ...
    <>
      <div>
        <div className="p-5   mb-10 text-center">
          ...
          to get a sign up reward bonus and an extra bonus if you use a referral
          code.
        </div>
          ...
          <div className="flex">
            <div className="flex flex-col gap-10 p-10">
              ...
              <div className="leading-loose tracking-[1px] ">
                ...
                Copy and share your referral code. You earn coins for each user
                who joins with your code,
            ...
            <div className="flex flex-col gap-10 p-10 pt-0">
              <div className="leading-loose tracking-[1px]">
                ...
                <span className="font-bold">
                  Tap the language icon to translate into your chosen language.
                </span>
              </div>
              <div className="leading-loose tracking-[1px]">
                <span className="font-bold">Check in</span> every 15 minutes to
                earn coins and ad points
                <span className="font-bold">
              ...
              <div className="leading-loose tracking-[1px]">
                ...
                View the circles you follow, unfollow easily, check the owner’s
                profile, and more. Enter a circle to see its content.
                <span className="font-bold">
                  Clicking on content earns coins for you and the circle owner.
                </span>
              </div>
        ...
        <div className="text-center p-5">
          We never stop growing as a community, integrating more features to our
          ecosystem. Be part of revolution
        </div>
      </div>
    </>
  );
